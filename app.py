...
PRODUCT_PAGES = [
    ...
    },
    {
        ...
        "customer_label": "客户旺旺",
        "craft_groups": [
            {"key": "cut", "label": "裁切工艺", "multi": False, "options": ["模切", "裁切"]},
            {"key": "lamination", "label": "覆膜工艺", "multi": False, "options": ["覆膜", "不覆膜"]},
            {"key": "accessory", "label": "配件", "multi": True, "options": ["粘牙签", "加急"]},
        ],
        "pricing": {
            ...
            "craft_fee": {"模切": 8, "裁切": 0, "覆膜": 12, "不覆膜": 0, "粘牙签": 18, "加急": 20},
        },
        "result_lines": ["牙签插旗当前为本地 demo 报价，真实生产价后续可接领淘基线。", "默认按单面印刷和粘牙签场景整理。"],
    ...
    },
    {
        ...
        "customer_label": "客户旺旺",
        "craft_groups": [
            {"key": "baseCraft", "label": "基础工艺", "multi": True, "options": ["打孔", "异形模切", "圆角", "打点线", "压痕", "配流苏", "穿流苏"]},
            {"key": "commonCraft", "label": "常见工艺", "multi": True, "options": ["打码", "单面烫金", "双面烫金"]},
        ],
        "pricing": {
    ...
    },
    {
        ...
        "customer_label": "客户旺旺",
        "craft_groups": [
            {"key": "commonCraft", "label": "常见工艺", "multi": False, "options": ["打孔", "不打孔"]},
            {"key": "accessory", "label": "配件", "multi": True, "options": ["配件", "挂圈", "链条", "加急"]},
        ],
        "pricing": {
            ...
            "craft_fee": {"打孔": 0, "不打孔": 0, "配件": 8, "挂圈": 6, "链条": 10, "加急": 20},
        },
